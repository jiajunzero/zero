		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?php echo C('VIEW_IMG_PATH').$data['goods_img'];?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?php echo C('VIEW_IMG_PATH').$data['goods_thumb'];?>" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li class="market_price"><span>定价：</span><em>￥<?php echo $data['goods_price']*1.5;?></em></li>
						<li class="shop_price"><span>本店价：</span> <strong>￥<?php echo ($data['goods_price']); ?></strong> <a href="">(降价通知)</a></li>
						<li><span>上架时间：</span><?php echo date('Y-m-d H:i',$data['add_time']);?></li>
						...
						<ul>
							...
							<li class="product">
								<dl>
									...
									<dd><?php foreach ($v as $key => $val):?>
										<a  href="javascript:;">
											<?php echo $val['goods_attr_values']?>
											<input type="radio" name="color<?php echo $k;?>" value="<?php echo $val['attrs_id']?>" />
										</a><?php endforeach?>
