		...
		<div class="topnav_bd w1210 bc">
			...
			<div class="topnav_right fr">
				<ul>
					...
					<?php }?>
					<li class="line">|</li>
					<li><a href="<?php echo U('Cart/cartList');?>">我的订单</a></li>
					<li class="line">|</li>
					<li>客户服务</li>
	...
	<div class="header w1210 bc mt15">
		...
		<div class="nav w1210 bc mt10">
			...
			<div class="category fl"> <!-- 非首页，需要添加cat1类 -->
				...
				<div class="cat_bd">
					<?php  foreach($cate as $k1 => $v1 ){?>
					<div class="cat item1">
						<h3><a href=""><?php echo $v1['cate_name'] ?></a> <b></b></h3>
						<div class="cat_detail">
							<?php foreach($v1['children'] as $k2 =>$v2){?>
							<dl class="dl_1st">
								<dt><a href=""><?php echo $v2['cate_name']?></a></dt>
			...
			<div class="navitems fl">
				...
				<ul class="fl">
					...
					<?php foreach($headCate as $v){?>
					<li>
						<a href="<?php echo $v['url']?:U('index/category',array('cate_id'=>$v[cate_id])) ?>">
			...
			<div class="guide_wrap">
				...
				<div class="crazy">
					<ul>
						...
						<li>
							<dl>
								<dt><a href="/index.php/Home/Index/detail/goods_id/<?php echo $v['goods_id']?>"><img src="<?php echo C('VIEW_IMG_PATH').$v['goods_thumb']?>" alt="" /></a></dt>
								<dd><a href="/index.php/Home/Index/detail/goods_id/<?php echo $v['goods_id']?>"><?php echo $v['goods_name']?></a></dd>
				...
				<div class="guess none">
					<ul>
						<?php if(is_array($guessData)): foreach($guessData as $key=>$k): ?><li>
							<dl>
								<dt><a href="/index.php/Home/Index/detail/goods_id/{ $k['goods_id']}"><img src="<?php echo C('VIEW_IMG_PATH').$k['goods_thumb'];?>" alt="" /></a></dt>
								<dd><a href="/index.php/Home/Index/detail/goods_id/<?php echo ($k['goods_id']); ?>"><?php echo ($k['goods_name']); ?></a></dd>
								<dd><span>售价：</span><strong><?php echo ($k['goods_price']); ?></strong></dd>
							</dl>
