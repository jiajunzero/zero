			...
			<div class="login_form fl">
				<form action="" method="post">
					<ul>
						...
						<li>
							<label for="">　</label>
							<button id="phone" style="height:35px">获取手机验证码</button>
							<input type="text" class="txt" name="yzm"  placeholder="请输入验证码" style="width:183px; height:25px" />
						</li>
...
<script>
    ...
    $('#phone').click(function(){
		...
		var self=this;
		$.ajax({
			url:'/index.php/Home/Member/ajaxYzm',
			type:'get',
			data:{'phone':_phone},
			dataType:'json',
