        ...
        <div class="div_head">
            <span>
                ...
                <span style="float: right; margin-right: 8px; font-weight: bold;">
                    <a style="text-decoration: none;" href="/index.php/Admin/Role/add">【添加权限】</a>
                </span>
            </span>
        </div>
        <div></div>
        ...
        <div style="font-size: 13px; margin: 10px 5px;">
            <table class="table_a" border="1" width="100%" id="event_tb">
                ...
                <tr id="product1">
                    ...
                    <td><?php echo $v['role_id_list']=='*'?'*':$v['auth_name']?></td>

                    <td><?php if($v['role_id']!=1):?>
                        <a href="/index.php/Admin/Role/upd/role_id/<?php echo $v['role_id']?>">

                            <button>修改</button></a>
                        <button class="del" role_id="<?php echo $v['role_id']?>" >删除</button>
                        <?php endif?>
                    </td>
...
<script>
    ...
    $('#event_tb').click(function(event){
       ...
       if(_class=='del'){
           ...
           var role_id=_target.attr('role_id');
           $.ajax({
