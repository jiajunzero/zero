...
@section('title')直播流列表@endsection
...
<div class="page-container">
	...
	{{--</div>--}}
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="course_add('添加直播流','{{url('admin/livestream/create')}}','1100','')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加直播流</a></span> <span class="r">共有数据：<strong>{{$count}}</strong> 条</span> </div>
	<div class="mt-20">
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<thead>
        <tr>
            <th scope="col" colspan="12" style="text-align: center;font-size:20px">直播流列表</th>
        </tr>
			<tr class="text-c">
				<th width="25"><input type="checkbox" name="" value=""></th>
				<th width="30">ID</th>
				<th width="140">直播流名称</th>
				<th width="100">禁用状态</th>
				<th width="100">禁播时间</th>
...
$(function(){
    $('.table-sort').DataTable({
        ...
        'columnDefs':[{
            'targets':[0,2,-1],  //不参与排序的列
            'orderable':false
        }],
        'processing':true,   //显示数据在处理中的状态
        'serveSide':true,   //是否开启服务端
        'ajax':{
            'url':"{{url('admin/livestream/ajax_list')}}",
            'type':'post',
        ...
        "columns": [
            ...
            {'data':'stream_name',"defaultContent":" "},
