...
<article class="page-container">
	<form action="{{url('admin/auth')}}" method="post" class="form form-horizontal" id="form-admin-auth-add">
		{{csrf_field()}}
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>权限名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" id="authName" name="auth_name" datatype="*4-16" nullmsg="用户账户不能为空">
			</div>
		</div>
		<div class="row cl">
			...
			<select class="select" name="auth_pid" size="1">
				...
				{{--@if($item->auth_pid!=0)--}}
					<option value="{{$item['id']}}">{{str_repeat('--',$item['level']).$item['auth_name']}}</option>
				{{--@endif--}}
				@endforeach
			</select>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="auth_controller">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>方法名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="auth_action">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>路由地址：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="auth_address">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="radio-box">
					<input name="is_menu" type="radio" id="auth-1" checked value="1">
					<label for="auth-1">是</label>
				</div>
				<div class="radio-box">
					<input name="is_menu" type="radio" id="auth-2"  value="0">
